#include <Oceaniolib/Oceanio.hpp>
#include <Oceaniolib/print.hpp>
#include <Oceaniolib/singleton.hpp>
#include <Oceaniolib/crypto.h>
#include <boost/algorithm/string.hpp>


using namespace Oceanio;
using namespace std;

typedef uint128_t key_n_t;

class hello : public Oceanio::contract {
    public:
        ...
        struct keyval {
            ...
            OceanLIB_SERIALIZE( keyval, (id)(key_n)(key_s)(val) )
        };
        ...
        void addprm( name user, string key, string val, uint64_t id ) {
            ...
            Oceanio::multi_index<N(keyval), keyval
...
OceanIO_ABI( hello, (remove)(addprm)(addsec) ) 
